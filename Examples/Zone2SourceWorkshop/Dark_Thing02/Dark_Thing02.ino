...
const IntMap map_eda_to_volume(EDA_MIN, EDA_MAX, 0, 255); 
...
void updateControl(){
  ...
  vol_swell = map_eda_to_volume(constrain(gsrval, EDA_MIN, EDA_MAX)); // swell volume is tracked by direct EDA values
  vol_ostinato1 = constrain(map_responses_to_volume_short(gsrval), 0, 255); // maps eda activity to ostinato volume
  vol_ostinato2 = constrain(map_responses_to_volume_long(gsrval), 0, 255); // maps eda activity to ostinato volume
